...
<?php include 'include/menu.php'; ?>
   ...
   <form action="<?php echo $base_url?>/checkout-form.php" method="post">
        <div class="row g-5">
            <div class="col-md-6 col-lg7">
                <div class="row g-3">
                    <div class="col-sm-12">
                        <label class="form-label">Fullname</label>;
                        <input type="text" name="fullname" class="form-control" placeholder="" value="<?php echo$_SESSION['username'] ?>"/>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="">
                        ...
                        <input type="radio" name="discount" class="" placeholder="" value=100 />
                        <label class="form-label">Discount for you</label>
                    </div>
                    <div class="">
                        <label class="form-label">500฿</label>
                        <input type="radio" name="discount" class="" placeholder="" value=500 />
                        <label class="form-label">Discount for you</label>
                    </div>
                    <div class="">
                        <label class="form-label">1,000฿</label>
                        <input type="radio" name="discount" class="" placeholder="" value=1000 />
                        <label class="form-label">Discount for you</label>
                    </div>
            ...
            <ul class="list-group mb-3">
                ...
                <?php while($product = mysqli_fetch_assoc($query)):?>
                    <li class="list-group-item d-flex justify-content-between 1h-sm">
                        <div>
                            <h6><?php echo $product['product_name']; ?>(<?php echo $_SESSION['cart'][$product['id']]; ?>)</h6>
                        ...
                        <span class="text-body-secondary"><strong>฿<?php echo number_format($_SESSION['cart'][$product['id']]*$product['price'],2);?></strong></span>
                    </li>
